...
function getIconNode(logoKey: string, size: number) {
  ...
  switch (logoKey) {
    ...
    case "messenger":   return <SiMessenger className={cls} />;
    case "telegram":    return <SiTelegram className={cls} />;
    case "photos":      return <Image className={cls} />;
    case "videos":      return <Video className={cls} />;
    case "audio":       return <Mic className={cls} />;
    case "magic":       return <Wand2 className={cls} />;
    ...
    case "snapchat":    return <SiSnapchat className={cls} />;
    case "twitter":     return <SiX className={cls} />;
    case "gmail":       return <SiGmail className={cls} />;
    case "drive":       return <SiGoogledrive className={cls} />;
    case "googlephotos":return <SiGooglephotos className={cls} />;
    case "spotify":     return <SiSpotify className={cls} />;
    case "tiktok":      return <SiTiktok className={cls} />;
    case "viber":       return <SiViber className={cls} />;
    case "signal":      return <SiSignal className={cls} />;
    case "line":        return <SiLine className={cls} />;
    case "imo":         return <MessageCircle className={cls} />;
